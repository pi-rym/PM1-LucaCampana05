...
newImage.src = urlimgValue;

// Aplicar estilos CSS para controlar el tamaño de la imagen
newImage.style.maxWidth = "200px"; // Establecer el ancho máximo
newImage.style.maxHeight = "200px"; // Establecer la altura máxima

// Agregar un event listener para el evento de clic izquierdo
newImage.addEventListener("click", function(event) {
    // Eliminar la imagen al hacer clic izquierdo
    event.target.remove();
});
...
container_act.appendChild(newImage);
}
